...
//     <input
//       type="text"
//       className="rounded border w-1/2 flex items-center"
//     ></input>
//   </form>,
// ];
...
export default function Signup() {
  ...
  return (
    <>
      {render ? (
        <div>oops were still working on this one</div>
      ) : (
        <div className="p-8 pt-28 gap-y-6 flex flex-col">
          ...
          <div className="mb-12 p-10">
            ...
            <p className="text-neutral-800 sm:text-l md:text-1xl font-small mb-4 dark:text-neutral-600 ">
              A club member will reach out and assist you in your on boarding
              after the submition of your club application
            </p>
            ...
            <p className="p-3">
              Expectaions?What do you hope to gain from joining the club?
            </p>
            {/* {inputBox} */}
